...
docker run -d \
  --name listmonk-app \
  --network listmonk_listmonk-network \
  -p 9000:9000 \
...
echo ""
echo "📊 UTILISATION :"
echo "   • Utilisez les filtres Listmonk sur les attributs JSON"
echo "   • Exemple de filtre : attribs->>'geo'->>'region' = 'Île-de-France'"
echo "   • Ou : attribs->>'geo'->>'departement' = '75'"
echo ""
