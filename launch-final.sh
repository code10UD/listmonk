...
# Script de lancement final avec installation complète

set -e

echo "🚀 LANCEMENT LISTMONK COMPLET"
echo "============================="
...
echo -e "y\nadmin\nadmin123" | ./listmonk --install --config config-final.toml
...
./listmonk --config config-final.toml &
BACKEND_PID=$!
