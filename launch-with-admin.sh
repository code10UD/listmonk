...
# Script de lancement complet avec création d'utilisateur admin

set -e

echo "🚀 LANCEMENT LISTMONK AVEC UTILISATEUR ADMIN"
echo "============================================="
...
cat > config-with-admin.toml << EOF
[app]
...
./listmonk --config config-with-admin.toml &
BACKEND_PID=$!
...
echo ""
echo "✅ APPLICATION LISTMONK AVEC ADMIN DÉMARRÉE!"
echo "============================================="
echo ""
...
echo "   2. Se connecter avec admin@listmonk.local / admin123"
